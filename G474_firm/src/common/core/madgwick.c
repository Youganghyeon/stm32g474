...
const float dt = 1.0f / sampleFreq;  // 0.004f

volatile float beta = 0.033f;
...
void MadgwickAHRSupdate(float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz) {
    ...
    if(!((ax == 0.0f) && (ay == 0.0f) && (az == 0.0f))) {
        ...
        s2 = -_2q0*(2.0f*q1q3 - _2q0q2 - ax) + _2q3*(2.0f*q0q1 + _2q2q3 - ay)
             ...
             + (-2.0f*_2bx*q2 - _2bz*q0)*(_2bx*(0.5f - q2q2 - q3q3) + _2bz*(q1q3 - q0q2) - mx)
             + (_2bx*q1 + _2bz*q3)*(_2bx*(q1q2 - q0q3) + _2bz*(q0q1 + q2q3) - my)
             + (_2bx*q0 - 2.0f*_2bz*q2)*(_2bx*(q0q2 + q1q3) + _2bz*(0.5f - q1q1 - q2q2) - mz);

        s3 = _2q1*(2.0f*q1q3 - _2q0q2 - ax) + _2q2*(2.0f*q0q1 + _2q2q3 - ay)
             + (-2.0f*_2bx*q3 + _2bz*q1)*(_2bx*(0.5f - q2q2 - q3q3) + _2bz*(q1q3 - q0q2) - mx)
...
void computeAngles(void) {
    ...
    if (fabsf(sinp) >= 1.0f)
        pitch = copysignf(3.141592f / 2.0f, sinp) * R2D;
    else
